...
test_evaluator = dict(
    ann_file=
    '/mnt/sdb/lx/data/HazyDet/test/test_coco.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    classwise=True,
...
val_evaluator = dict(
    ann_file=
    '/mnt/sdb/lx/data/HazyDet/val/val_coco.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    classwise=True,
...
work_dir = '/mnt/sdb/lx/result/ICFF/hazydet/cascade-rcnn/cascade-rcnn_r50_hazydet'
